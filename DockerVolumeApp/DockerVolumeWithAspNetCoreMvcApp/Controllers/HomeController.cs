using DockerVolumeWithAspNetCoreMvcApp.Models;
using Microsoft.AspNetCore.Mvc;
using Microsoft.Extensions.FileProviders;
using System.Diagnostics;

namespace DockerVolumeWithAspNetCoreMvcApp.Controllers
{
    public class HomeController : Controller
    {
        ...
        {
            var file = _fileProvider.GetDirectoryContents("wwwroot/images").ToList()
                .First(x => x.Name == name);
